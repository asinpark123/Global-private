...
$(document).ready(function () {
	...
	let portalImg = document.querySelectorAll("#GlobalPortal .img-container img");
...
function sectionTracker() {
	...
	} else if (yOffset > ServicesY && yOffset < GlobalPortalY) {
...
function resizeOnScroll(){
	let ppVideo = document.querySelector(".GlobalPortal video");
